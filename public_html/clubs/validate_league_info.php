<?php
// filename: validate_league_info.php
...
if ($_FILES[$fieldname]['name'] !="")
{
	...
	$uploadsDirectory = $_SERVER['DOCUMENT_ROOT'] . '/images/standings/';

	// make a note of the location of the upload form in case we need it
	$uploadForm = 'http://' . $_SERVER['HTTP_HOST'] . '/clubs/league_info.php';

	// make a note of the location of the success page
	$uploadSuccess = 'http://' . $_SERVER['HTTP_HOST'] . $directory_self . 'league_info.php';
	...
	$thisclub = str_replace(" ","_",strtolower(get_clubname($_POST["clubid"])));
	
	$uploadFilename = '../images/standings/' . $thisseason . '_' . $thisclub . $ext;
...
if ($uploadFilename != "")
{
	$uploadFilename = str_replace("../images/standings/", "", $uploadFilename);
}

// go to league info again
...
echo "<form name='leagueinfo' action='league_info.php' method='post'>
	  <input type='hidden' name='id' value='" . $_POST[clubid] . "'></form>";
echo "<script>league_info()</script>";
echo "</body></html>";
